...
internal class TSpan : Figure() {
    ...
    companion object {
        ...
        val StyleDataAttrSpec = CLASS.registerDerivedAttr(TSpan::styleData, dependencies = setOf(FillAttrSpec, StrokeAttrSpec, StrokeWidthAttrSpec, StrokeLineCapAttrSpec))
    }
}
