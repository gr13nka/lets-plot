...
object TextUtil {
    ...
    // drawText carries no angle and can't reproduce the multi-line vertical layout pixel-for-pixel.
    ...
    internal fun textComponent(
        ...
        val g = SvgGElement()
        ctx.rendererFactory(SvgGElementRoot(g)).drawText(origin, text, style)
        return g
    }
