...
class LollipopGeom : GeomBase(), WithWidth, WithHeight {
    ...
    private inner class Lollipop(
        ...
        fun createStick(helper: GeomHelper): SvgElement? {
            ...
            val stick = helper.ctx.plotContext.comicStylize.applyLine(clientBase, neck)
            GeomHelper.decorate(stick, point, applyAlphaToAll = true, strokeScaler = AesScaling::lineWidth)

            return stick as SvgElement
        }
